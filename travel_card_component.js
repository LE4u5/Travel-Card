...
class TravelCardComponent extends HTMLElement {
    ...
    render() {
        ...
        if (this.shadow.querySelector('.card-cont')) {
            ...
            this.shadow.querySelector('.web-cont a').innerHTML = this.getAttribute('website');
            this.shadow.querySelector('.web-cont a').setAttribute('href',this.getAttribute('website'))
        }
    }
    setRatingStars(){
